...
class TextEditor:
  ...
  def __init__(self,root):
    ...
    # Initializing Status
    self.status.set("Lightnote Editor")
  ...
  def infoabout(self):
    messagebox.showinfo("About Lightnote","A Open Source Text Editor\nCreated using Python.")
  # Defining Version Function
  def version(self):
      messagebox.showinfo("Version","This is v1.0")
